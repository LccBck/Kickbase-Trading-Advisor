...
league_name = "Thomas TG"  # Name of your league, must be exact match, can be done via env or hardcoded
start_budget = 80_000_000               # Starting budget of your league, used to calculate current budgets of other managers
league_start_date = "2026-07-22"        # Start date of your league, used to filter activities, format: YYYY-MM-DD
email = os.getenv("EMAIL_TO", "lucca.bueck@gmail.com")

        # Email to send recommendations to, can be the same as EMAIL_USER or different
